...
def emit_header(rows, digest):
    d = dict(rows)
    h = ["/* Generated by tools/pairing/gen_pair_prov_vectors.py - do not edit. */",
         "/* Immutable once published: both firmwares compile against this. */",
         "#pragma once", "", "#include <stdint.h>", "",
         "#define PAIR_PROV_VECTORS_VERSION 1",
         f'#define PAIR_PROV_VECTORS_DIGEST  "{digest}"',
         "",
         ...
         f'#define PROV_REQ_SUPERFRAME     0x{d["prov_req_superframe"]}u',
         f'#define PROV_BEACON_SUPERFRAME  0x{d["prov_beacon_superframe"]}u',
         f'#define PROV_LIVE_SUPERFRAME    0x{d["prov_live_superframe"]}u',
         "",
         ...
         ""]
    for name, key in [
            ("PROV_TRANSCRIPT", "prov_transcript"),
            ("PROV_SALT", "prov_salt"),
            ("PROV_KEY_SESSION", "prov_key_session"),
            ("PROV_CONFIRM_HUB", "prov_confirm_hub"),
            ("PROV_CONFIRM_DEV", "prov_confirm_dev"),
            ("PROV_CONFIRM_HUB_IF_BEACON", "prov_confirm_hub_if_beacon"),
            ("PROV_CONFIRM_HUB_IF_LIVE", "prov_confirm_hub_if_live")]:
